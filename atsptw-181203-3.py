...
################################################################################################################################################################
klastrun  = 0					# Use klastrun  = 0 to start from scratch. Use Negative to start from any given run number.
...
while True:
	...
	# scip -c "set presolving emphasis aggressive set emphasis feasibility read myprob-0.mps optimize write solution sol-0.sol quit"
